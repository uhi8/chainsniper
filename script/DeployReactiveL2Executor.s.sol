...
contract DeployReactiveL2ExecutorScript is Script {
    function run() public {
        ...
        address poolManager = vm.envOr("POOL_MANAGER_ADDRESS", address(0x0000000000000000000000000000000000000001));
        address l1Monitor = vm.envOr("L1_MONITOR_ADDRESS", address(0x0000000000000000000000000000000000000002));
        ...
        ReactiveL2Executor executor = new ReactiveL2Executor(poolManager, l1Monitor);
